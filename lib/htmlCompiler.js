exports.compile = function compileTalapa(code, returnTemps) {
...
//list of tags:
  ...
  shouldReturnTemps = false;  //for reading templates and variables from other files
      ...
      case 'read':
        try {
          ...
          if (shouldReturnTemps) {
            var newTemps = {};
            newTemps = send.receive(data, true);
          }
